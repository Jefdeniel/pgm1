const lineup = [
  {
    ...
    band: {
      ...
      picture: {
        small:
          "https://www.rockwerchter.be/media/cache/default_band/upload/media/default/c64d/a5/51296a48e400a72b91fe8b422451603a0e9aa439.jpg",
      },
      media: [
        {
    ...
    comments: [
      {
        nickName: "JaPPa03",
        message:
          "In feite zijn deze camera’s een soort update die je doorgaans na interne feedback zou doorvoeren voordat je een product op de markt brengt. Vooral de dual card slot is iets wat ze verkeerd hebben ingeschat terwijl het geen nieuwe kritiek is op camera’s.",
        comments: [
          {
            nickName: "Inoble",
            message:
  ...
  },
  {
    ...
    band: {
      ...
      socials: {
        ...
        spotify:
          "https://open.spotify.com/artist/7Ln80lUS6He07XvHI8qqHH?si=16H4iXaBRs6WwD3v1KV3WA&nd=1",
      ...
      picture: {
        small:
          "https://www.rockwerchter.be/media/cache/default_band/upload/media/default/0d06/aa/daa228f07939589d2b5f34822b3a2f8c66d34d4a.jpg",
      },
      media: [
        {
          link: "WMxEKlDtt_4",
    ...
    reviews: [
      ...
      },
      {
        rating: 7,
        comment:
          "I've been a fan of Star Wars since I was a child in the 1980s. As such, I was very disappointed with Disney's latest trilogy. Thankfully, shows like the Mandalorian manage to steer well clear of the atrociousness that those three films are.",
  ...
  },
  {
    ...
    band: {
      ...
      picture: {
        small:
          "https://www.rockwerchter.be/media/cache/default_band/upload/media/default/0fe6/b8/188d68de6d211732f1e496c5a826b9536a78d7af.jpg",
      },
      media: [
        {
          link: "8muGWOjNoSo",
