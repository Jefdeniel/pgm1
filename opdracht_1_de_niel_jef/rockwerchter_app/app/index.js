const lineup = [
    ...
    comments: [
      {
        ...
        comments: [
          {
          comment: "Precies dat idee heb ik ook, een gevalletje D600, 800 > 610, 810. An sich natuurlijk een prima camera en feitelijk (aannemend) beter dan de voorgangers maar een upgrade niet waard wanneer je met Nikon schiet en graag bij Nikon wilt blijven.",  
          writtenBy: "Inoble"
          }
        ],
      }
  ...
  },
  {
    ...
    comments: [
      {
        nickName: "Nice, goede iteratie van de Z6 en Z7. Veel van de kritiekpunten zijn aangepakt",
        message: "Joris748", 
        comments: [
          {
          comment: "Als de APS-C crop voor 4K/60 op de Z6 geen probleem voor je is, is het zeker een mooie upgrade.",
          writtenBy: "JaPPa03"  
          },
          {
          comment: "In feite zijn deze camera’s een soort update die je doorgaans na interne feedback zou doorvoeren voordat je een product op de markt brengt. Vooral de dual card slot is iets wat ze verkeerd hebben ingeschat terwijl het geen nieuwe kritiek is op camera’s.",
          writtenBy: "Inoble",  
          },
        ],
      },
